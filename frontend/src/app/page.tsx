...
const FEATURES = [
  ...
  { icon: IconBan, title: 'No Templates, No Clichs', desc: 'Never starts with \u201CI am passionate\u201D or \u201Clook no further.\u201D Every proposal opens with a specific insight from the job.' },
      ...
      <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-sm border-b border-border">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link href="/auth/login" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors hidden sm:inline">Sign In</Link>
            {!mounted ? (
              <a href="#pricing" className="inline-flex items-center gap-1.5 bg-brand-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-brand-700 transition-all shadow-sm">
                Try It Now <IconChevronRight className="w-3.5 h-3.5" />
              </a>
            ) : hasSession ? (
              <Link href="/session" className="inline-flex items-center gap-1.5 bg-brand-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-brand-700 transition-all shadow-sm">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 md:pt-28 md:pb-32">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
              ...
              No templates, no clichs, no wasted connects. <strong className="text-foreground">30 seconds.</strong>
            </p>
